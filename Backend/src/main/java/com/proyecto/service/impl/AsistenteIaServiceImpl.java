...
public class AsistenteIaServiceImpl implements AsistenteIaService {
    ...
    public RespuestaIaDto resumenEjecutivo() {
        ...
        ResultadoGeneracionIa resultado =
                iaGenerativaService.generarRespuesta(
                        instrucciones,
                        "Genera un resumen ejecutivo del estado actual del proyecto.",
                        resumen);

        registrarAuditoria(0L, "RESUMEN_EJECUTIVO_ADMIN", "ADMIN", resultado.proveedor());
        return construirRespuesta(resultado, "RESUMEN_EJECUTIVO", "ADMIN", null);
    }
    ...
    private RespuestaIaDto responderAgregadoAdmin(String pregunta) {
        ...
        ResultadoGeneracionIa resultado = iaGenerativaService.generarRespuesta(instrucciones, pregunta, resumen);
        registrarAuditoria(0L, "CONSULTA_AGREGADA_ADMIN", "ADMIN", resultado.proveedor());
        return construirRespuesta(resultado, "AGREGADA_ADMIN", "ADMIN", null);
    }
    ...
    private RespuestaIaDto responderBeneficiarioAdmin(Long idBeneficiario, String pregunta) {
        ...
        ResultadoGeneracionIa resultado = iaGenerativaService.generarRespuesta(instrucciones, pregunta, contexto);
        registrarAuditoria(
                idBeneficiario, "CONSULTA_INDIVIDUAL_ADMIN", "ADMIN", resultado.proveedor());
        return construirRespuesta(resultado, "INDIVIDUAL_ADMIN", "ADMIN", idBeneficiario);
    }
    ...
    private RespuestaIaDto responderFuncionario(String pregunta) {
        ...
        ResultadoGeneracionIa resultado = iaGenerativaService.generarRespuesta(instrucciones, pregunta, contexto);
        registrarAuditoria(0L, "CONSULTA_FUNCIONARIO", "OPERADOR", resultado.proveedor());
        return construirRespuesta(resultado, "FUNCIONARIO", "OPERADOR", null);
    }
    ...
    private RespuestaIaDto responderUsuarioFinal(ConsultaIaDto dto) {
        ...
        ResultadoGeneracionIa resultado =
                iaGenerativaService.generarRespuesta(instrucciones, dto.getPregunta(), contexto);
        registrarAuditoria(
                idBeneficiario, "CONSULTA_PROPIA_USUARIO", "CONSULTA", resultado.proveedor());
        return construirRespuesta(resultado, "MI_INFORMACION", "CONSULTA", idBeneficiario);
    }
    ...
    private RespuestaIaDto construirRespuesta(
            ResultadoGeneracionIa resultado, String tipoConsulta, String rol, Long idBeneficiario) {
    ...
    private void registrarAuditoria(
            Long idBeneficiario, String operacion, String rol, String proveedor) {

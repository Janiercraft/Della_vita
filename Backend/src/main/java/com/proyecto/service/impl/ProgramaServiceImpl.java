...
public class ProgramaServiceImpl implements ProgramaService {
    ...
    private void copiarCampos(ProgramaDto dto, Programa registro) {
        registro.setCodigo(Normalizador.texto(dto.getCodigo()) == null ? null : Normalizador.clave(dto.getCodigo()));
        registro.setNombre(Normalizador.texto(dto.getNombre()));
        registro.setCodigoLinea(Normalizador.texto(dto.getCodigoLinea()));
        registro.setLineaIntervencion(Normalizador.texto(dto.getLineaIntervencion()));
        registro.setOrganizacionLider(Normalizador.texto(dto.getOrganizacionLider()));
        registro.setMetaEstimada(dto.getMetaEstimada());
    ...
    public ProgramaDto convertirADto(Programa registro) {
        ...
        dto.setCodigoLinea(registro.getCodigoLinea());
        dto.setLineaIntervencion(registro.getLineaIntervencion());
        dto.setOrganizacionLider(registro.getOrganizacionLider());
        dto.setMetaEstimada(registro.getMetaEstimada());

...
public class Beneficiario extends RegistroAuditable {
    ...
    @Column(name = "grupo_poblacional", length = 150)
    private String grupoPoblacional;

    @Column(name = "pertenencia_etnica", length = 150)
    private String pertenenciaEtnica;

    @Column(name = "jefatura_hogar", nullable = false)
    private Boolean jefaturaHogar = false;

    @Column(name = "tiene_discapacidad", nullable = false)
    private Boolean tieneDiscapacidad = false;

    @Column(name = "discapacidad", length = 500)

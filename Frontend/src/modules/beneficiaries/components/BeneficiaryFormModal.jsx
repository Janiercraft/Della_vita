...
export function BeneficiaryFormModal({
  ...
  const [newMember, setNewMember] = useState({ fullName: '', kinship: 'Hijo(a)', age: '', documentType: 'SD', documentNumber: '' });
    ...
    setFormData(prev => ({
      ...
      familyMembers: [
        ...prev.familyMembers,
        {
          ...
          documentNumber: newMember.documentNumber.trim()
        }
      ]
    }));
    setNewMember({ fullName: '', kinship: 'Hijo(a)', age: '', documentType: 'SD', documentNumber: '' });
    setShowMemberForm(false);
  };

...
import { Users, FolderGit2, HeartHandshake, BarChart3, Shield, MapPin, X, BookOpen } from 'lucide-react';
        ...
        >
          ...
          >
            <span style={{ fontWeight: 600, color: '#C8DDD8' }}>
              {currentUser?.title || (role === 'admin' ? 'Coordinador General' : 'Beneficiario(a) Titular')}
            </span>
            <span
              style={{
                fontSize: '0.7rem',
